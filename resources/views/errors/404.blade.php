...
<body class="min-h-screen flex flex-col items-center justify-center">
    <div
        ...
        <p class="mt-4 text-xl text-blue-500">Maaf, halaman yang Anda cari tidak ditemukan.</p>
        <p class="mt-2 text-md text-blue-400">Mungkin halaman tersebut sudah dihapus atau URL yang Anda masukkan salah.
        </p>
        <a href="{{ url('/') }}"
