...
<body class="min-h-screen flex flex-col items-center justify-center">
    <div
        ...
        <div class="mb-6">
            <!-- Ikon error dengan animasi pulse -->
            <i class="fa-solid fa-circle-exclamation text-blue-500 text-7xl pulse"></i>
        </div>
        <h1 class="text-6xl font-bold text-blue-600">405</h1>
        <p class="mt-4 text-xl text-blue-500">Maaf, metode yang Anda gunakan tidak diizinkan.</p>
        <p class="mt-2 text-md text-blue-400">
            Mungkin Anda mencoba melakukan request dengan metode yang tidak didukung.
        </p>
        <a href="{{ url('/') }}"
